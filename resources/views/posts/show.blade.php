...
@section('content')
    <div class="max-w-5xl mx-auto p-8">
        ...
        <button onclick="window.location.href='{{ route('posts.index') }}';"
            class="flex items-center gap-2 text-[#402988] hover:text-[#3713a4] font-bold mb-6 transition">
            ← Kembali
        </button>
        ...
        <div class="grid md:grid-cols-3 gap-10">
            ...
            <div class="md:col-span-2">
                ...
                <p class="text-gray-500 mb-6">
                    Oleh <a href="{{ route('author.profile', $post->user->id) }}"
                ...
                <div class="bg-white rounded-2xl shadow p-6 mt-5">
                    ...
                    <div class="flex flex-col gap-3">
                        @forelse($post->chapters as $chapter)
                            <a href="{{ route('posts.read', [$post->id, $chapter->id]) }}"
